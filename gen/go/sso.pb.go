...
const file_sso_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId2\xab\x01\n" +
	"\x04Auth\x129\n" +
...
var file_sso_proto_goTypes = []any{
	(*IsAdminResponse)(nil),  // 0: auth.IsAdminResponse
...
var file_sso_proto_depIdxs = []int32{
	...
	1, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	5, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	0, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdminResponse
